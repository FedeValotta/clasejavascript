...
function ejecutarCotizador(event) {
    ...
    test.innerHTML = `Los tickets de ${ticketsMayores.destino} para mayores salen ${ticketsMayores.precio}. En su familia viajan ${cantidadTicketsMayores} mayores. El precio total de Tickets de Mayores es de USD ${ticketsMayores.precio * cantidadTicketsMayores} <br>
